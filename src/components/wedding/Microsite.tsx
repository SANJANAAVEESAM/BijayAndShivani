...
import storyAirport from "@/assets/placeholder-portrait.png";
import storyCamping from "@/assets/placeholder-portrait.png";
import storyOodenny from "@/assets/placeholder-portrait.png";
...
// TODO(content): the couple's story. Placeholders until they send it —
// nothing here should reach a guest as written.
const CHAPTERS = [
  {
    label: "Chapter I",
    title: "TODO — how they met",
    body: ["TODO(content): the first chapter, in the couple's own words."],
    quote: "",
    photos: [
      {
        src: storyCamping,
  ...
  },
  {
    label: "Chapter II",
    title: "TODO — the turn",
    body: ["TODO(content): the second chapter."],
    photos: [
      {
        src: storyAirport,
        caption: "TODO — where",
  ...
  },
  {
    label: "Chapter III",
    title: "TODO — now",
    body: ["TODO(content): the third chapter."],
    quote: "",
    photos: [
      {
        src: storyOodenny,
